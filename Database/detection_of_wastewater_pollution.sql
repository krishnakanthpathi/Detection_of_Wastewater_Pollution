...
--
-- Host: localhost
-- Generation Time: Oct 05, 2023 at 11:51 AM
...
--
-- Database: `detection_of_wastewater_pollution`
--
CREATE DATABASE IF NOT EXISTS `detection_of_wastewater_pollution` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `detection_of_wastewater_pollution`;
...
('6cnru8qveoi8s162r78i2qi27qs5vr29', 'eyJ1c2VyaWQiOjN9:1ql8Vd:dUrLTGKL8OHl50nbtv4KwwDJtKc4VCRG0TFHX7zll9w', '2023-10-10 13:53:53.582524'),
...
('f3ctfr7lvza8bnxpl1ufp4v4tb0b0c7p', 'eyJ1c2VyaWQiOjF9:1ql7ro:oSQZJNkGev6Ji6oPrFbMLMkyPUOyUIy5KFHEnlJfyIU', '2023-10-10 13:12:44.674344'),
...
(1, 'Abinay', 'Abinay123@gmail.com', 'Abinay', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju19@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(3, 'tmksmanju', 'tmksmanju19@gmail.com', 'tmksmanju', '9535866270', 'India', 'Karnataka', 'Bangalore', '#90928,8th Cross,Malleshwaram', 'Male');
...
(26, 'Random Forest Classifier', '41.935483870967744'),
(27, 'Artificial Neural Networks--ANN', '45.96774193548387'),
(28, 'SVM', '46.774193548387096'),
(29, 'Decision Tree Classifier', '48.38709677419355'),
(30, 'KNeighborsClassifier', '50.806451612903224');
...
(16, 'High Wastewater Pollution', '42.857142857142854'),
(17, 'No Wastewater Pollution', '57.14285714285714');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_water_type`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_water_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(300) NOT NULL,
  `Name_of_Monitoring_Location` varchar(300) NOT NULL,
  `Type_Water_Body` varchar(300) NOT NULL,
  `State_Name` varchar(300) NOT NULL,
  `Temperature` varchar(300) NOT NULL,
  `Dissolved_Oxygen_mgperL` varchar(300) NOT NULL,
  `pH` varchar(300) NOT NULL,
  `Conductivity_mhospercm` varchar(300) NOT NULL,
  `BOD_mgperL` varchar(300) NOT NULL,
  `NitrateN_NitriteN_mgperL` varchar(300) NOT NULL,
  `Fecal_Coliform_MPNper100ml` varchar(300) NOT NULL,
  `Total_Coliform_MPNper100ml` varchar(300) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=8 ;

--
-- Dumping data for table `remote_user_predict_water_type`
--

INSERT INTO `remote_user_predict_water_type` (`id`, `Fid`, `Name_of_Monitoring_Location`, `Type_Water_Body`, `State_Name`, `Temperature`, `Dissolved_Oxygen_mgperL`, `pH`, `Conductivity_mhospercm`, `BOD_mgperL`, `NitrateN_NitriteN_mgperL`, `Fecal_Coliform_MPNper100ml`, `Total_Coliform_MPNper100ml`, `Prediction`) VALUES
(1, '10.42.0.151-123.125.115.190-35010-80-6', 'DALI TANK', 'Wetland', 'ANDHRA PRADESH', '31', '7.3', '8.5', '18950', '2.5', '2.82', '15', '150', 'No Wastewater Pollution'),
(2, '172.217.7.163-10.42.0.211-443-40800-6', 'P .S. CHINNAIAH PALEM', 'Wetland', 'ANDHRA PRADESH', '30', '8', '8.2', '1340', '4.1', '1.92', '21', '210', 'No Wastewater Pollution'),
(3, '10.42.0.211-10.42.0.1-63824-53-17', 'PEDDA CHERUVU', 'Wetland', 'ANDHRA PRADESH', '32', '7.5', '7.7', '1450', '54', '6.09', '39', '2400', 'High Wastewater Pollution'),
(4, '205.185.216.42-10.42.0.211-80-49294-6', 'SOMASILA BACK WATER', 'Wetland', 'ANDHRA PRADESH', '29', '6.5', '7.9', '795', '1.8', '0.94', '373', '594', 'High Wastewater Pollution'),
(5, '180.149.138.210-10.42.0.211-80-37279-6', 'DALONI BEEL NEAR JOGIGHOPA, ASSAM', 'LAKE', 'ASSAM', '36', '5.5', '7.8', '81', '2.6', '1.1', '730', '1500', 'No Wastewater Pollution'),
(6, '203.205.147.229-10.42.0.151-80-50842-6', '"BORDOIBAM BEELMUKH BIRD SANCTUARY, DHEMAJI"', 'LAKE', 'ASSAM', '26', '8.5', '7.7', '208', '2.7', '1.2', '910', '2000', 'No Wastewater Pollution'),
(7, '174.36.210.49-10.42.0.211-443-54136-6', '"HOLUDUNGA BEEL NEAR GAI NADI/ RIVER AT SOMARAJAN, DHEMA JI"', 'LAKE', 'ASSAM', '25', '8.4', '7.6', '130', '2.8', '0.9', '730', '1500', 'High Wastewater Pollution');
