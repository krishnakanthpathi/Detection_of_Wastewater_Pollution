...
ROOT_URLCONF = 'detection_of_wastewater_pollution.urls'
...
WSGI_APPLICATION = 'detection_of_wastewater_pollution.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'detection_of_wastewater_pollution',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
